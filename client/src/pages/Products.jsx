...
function ProductSection({
  ...
  return (
    <section
      className={`product-section${reversed ? " reversed" : ""}`}
      id={id}
    >
  ...
  return (
    <main className="products-page">
      ...
      <ProductSection
        ...
        longDescription="Bring your wardrobe to life with RealFit AI using your own photos and key parameters like height, weight, and body shape.   RealFit AI uses advanced generative models to create accurate virtual try-ons that show how clothes will fit and look on you. Perfect for online shopping, outfit planning, and discovering new styles without the hassle of returns."
        features={[
          "Virtural Fittings: Generate lifelike try-ons from product images and your profile. Preview fit, drape, and style before you buy.",
          "In-App Browser: Search and shop from your favorite retailers without leaving the app.",
          "Full-body Simulation: Create a realistic full-body representation from a headshot and key measurements to anchor your try-ons.",
          "Alblum Viewing: Every fitting is saved to your personal album. Browse past looks, compare outfits, and share your style with friends.",
      ...
      <section className="coming-soon-section">
        <div className="coming-soon-inner">
          ...
          <p>
            We're constantly researching, designing, and building. The Nibblr
            team is working on exciting new products that will continue to bring
            thoughtful AI to everyday life. Stay tuned — or reach out if you
            have an idea to share.
          </p>
          <a href="/support" className="btn btn-primary-outline">
